...
{% include helper_image.html src="/resources/images/content/alexandra_elbakyan.png" size=4 float="end" caption="Sans Alexandra Elbakyan, l’accès à la littérature scientifique mondiale serait impossible sans payer de lourdes redevances à des éditeurs dispensables." %}
